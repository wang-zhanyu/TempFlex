IMAGE_FOLDER="./"
VIDEO_FOLDER="./"
DATA_YAML="stage_3.yaml"

PREV_STAGE_CHECKPOINT='./checkpoints/qwen3/tempflex_qwen3_stage2/checkpoint-xxx'
...
BASE_RUN_NAME="tempflex_qwen3_stage3"
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${ARNOLD_WORKER_GPU}" --nnodes="${ARNOLD_WORKER_NUM}" --node_rank="${ARNOLD_ID}" --master_addr="${METIS_WORKER_0_HOST}" --master_port="${port_in_cmd}" \
    ...
    --mm_tunable_parts="mm_temporal_encoder,mm_mlp_adapter" \
    --learning_rate 1e-5 \
