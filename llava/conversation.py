        ...
        if self.sep_style == SeparatorStyle.SINGLE:
            ...
            for i, (role, message) in enumerate(messages):
                ...
                if message:
                    ...
                    ret += role
        elif self.sep_style == SeparatorStyle.THOTH:
            ret = self.system
            for role, message in messages:
                if message:
                    if type(message) is tuple:
...
conv_thoth = Conversation(
    system="",
    roles=("<[BOS_never_used_51bce0c785ca2f68081bfa7d91973934]>user\n", "<[BOS_never_used_51bce0c785ca2f68081bfa7d91973934]>assistant\n"),
    version="thoth",
    messages=[],
    offset=0,
    sep_style=SeparatorStyle.THOTH,
    sep="<[EOS_never_used_51bce0c785ca2f68081bfa7d91973934]>\n",
)
